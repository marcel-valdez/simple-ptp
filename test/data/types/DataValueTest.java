...
public class DataValueTest {
     ...
     */
    @Test
    public void testToUValue() {
        System.out.println("ToUValue");
        // Arrange
        int bytes = 8;
        DataValue instance = new UInt8(12);
        long expResult = 12L;
        
        // Act
        long result = instance.ToValue(bytes);
    ...
    public void testEquals() {
        ...
        boolean result = instance.equals(data);
        assertEquals(expResult, result);
